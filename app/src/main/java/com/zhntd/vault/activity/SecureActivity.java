...
import com.zhntd.vault.application.VaultApp;
import com.zhntd.vault.secure.PinKey;
import com.zhntd.vault.secure.SecurityLockManager;
import com.zhntd.vault.secure.VividDotListener;
import com.zhntd.vault.utils.Logger;
import com.zhntd.vault.utils.PreferenceHelper;
import com.zhntd.vault.utils.ViewAnimatorUtil;
import com.zhntd.vault.widget.DigitButton;
import com.zhntd.vault.widget.PinPadLayout;
import com.zhntd.vault.widget.VividDot;
...
public abstract class SecureActivity extends Activity implements VividDotListener {
    ...
    protected void preparePinPad() {
        if (mPinLayout == null) {
            mPinLayout = (RelativeLayout) LayoutInflater.from(this)
                    .inflate(R.layout.layout_pin_pad, (android.view.ViewGroup) getWindow().getDecorView(), false);
    ...
    protected void addPinPad(boolean animate, PinPadLayout.PinPadMode mode) {
        ...
        group.addView(mPinLayout, params);
        if (animate) {
    ...
    protected void onPinCorrect() {
        Logger.i("onPinCorrect: ", getClass());
        removePinPad(true);
    }
